...
class HotelSearchfilter(APITestCase):
    def setUp(self) -> None:
                    new_user1 ={
    ...
    def test_length1_is_ok_but_result_not_ok1(self):
        request1=self.client.get(reverse("nearhotel"),self.myloc1).json()
